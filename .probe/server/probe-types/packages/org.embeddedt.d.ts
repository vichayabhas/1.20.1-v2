...
declare module "packages/org/embeddedt/embeddium/chunk/biome/$ExtendedBiomeSpecialEffects" {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ExtendedBiomeSpecialEffects$Type = ($ExtendedBiomeSpecialEffects);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $ExtendedBiomeSpecialEffects_ = $ExtendedBiomeSpecialEffects$Type;
}}
