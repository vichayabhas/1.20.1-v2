...
export class $BufferBuilder extends $DefaultedVertexConsumer implements $BufferVertexConsumer, $BufferBuilderExtension, $ExtendedBufferBuilder, $VertexBufferWriter {
...
import {$BlendModeMixin, $BlendModeMixin$Type} from "packages/com/lowdragmc/shimmer/core/mixins/$BlendModeMixin"

export class $BlendMode implements $BlendModeMixin {
