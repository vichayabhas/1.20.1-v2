...
import {$AbstractRegistrate, $AbstractRegistrate$Type} from "packages/com/tterrag/registrate/$AbstractRegistrate"
import {$BlockEntityBuilderAccessor, $BlockEntityBuilderAccessor$Type} from "packages/com/epimorphismmc/monomorphism/mixins/accessors/$BlockEntityBuilderAccessor"
...
export class $BlockEntityBuilder<T extends $BlockEntity, P> extends $AbstractBuilder<($BlockEntityType<(any)>), ($BlockEntityType<(T)>), (P), ($BlockEntityBuilder<(T), (P)>)> implements $BlockEntityBuilderAccessor<(any)> {
