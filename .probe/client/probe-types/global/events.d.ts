...
import {$InformationREIEventJS, $InformationREIEventJS$Type} from "packages/dev/latvian/mods/kubejs/integration/rei/$InformationREIEventJS"
...
import {$RemoveREICategoryEventJS, $RemoveREICategoryEventJS$Type} from "packages/dev/latvian/mods/kubejs/integration/rei/$RemoveREICategoryEventJS"
import {$ItemDroppedEventJS, $ItemDroppedEventJS$Type} from "packages/dev/latvian/mods/kubejs/item/$ItemDroppedEventJS"
import {$RemoveREIRecipeEventJS, $RemoveREIRecipeEventJS$Type} from "packages/dev/latvian/mods/kubejs/integration/rei/$RemoveREIRecipeEventJS"
import {$Block, $Block$Type} from "packages/net/minecraft/world/level/block/$Block"
import {$AddREIEventJS, $AddREIEventJS$Type} from "packages/dev/latvian/mods/kubejs/integration/rei/$AddREIEventJS"
...
import {$CustomFilterItemEventJS, $CustomFilterItemEventJS$Type} from "packages/dev/ftb/mods/ftbxmodcompat/ftbquests/kubejs/$CustomFilterItemEventJS"
...
import {$GroupREIEntriesEventJS, $GroupREIEntriesEventJS$Type} from "packages/dev/latvian/mods/kubejs/integration/rei/$GroupREIEntriesEventJS"
...
import {$HideREIEventJS, $HideREIEventJS$Type} from "packages/dev/latvian/mods/kubejs/integration/rei/$HideREIEventJS"
...
function add(extra: string, handler: (event: $AddREIEventJS<(any), (any)>) => void): void
function hide(extra: string, handler: (event: $HideREIEventJS<(any), (any)>) => void): void
function removeRecipes(handler: (event: $RemoveREIRecipeEventJS) => void): void
function information(handler: (event: $InformationREIEventJS) => void): void
function removeCategories(handler: (event: $RemoveREICategoryEventJS) => void): void
function groupEntries(handler: (event: $GroupREIEntriesEventJS) => void): void
}
